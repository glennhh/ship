...
for file in fileList:  
    ...
    #contours = skimage.measure.find_contours(labeledShip, 0.7)

    #segmentation =  cv2.cvtColor(np.float32(segmentation),cv2.COLOR_GRAY2RGB)
    ...
    #show4(img, 'Input', markers, 'Edge', segmentation, 'Segmentation', imgMask, 'Mask') 


    #for contour in contours:
    #    shade = drawShape(segmentation, contour, [255, 0,0]) 
